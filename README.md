...
<table>
	<tr>
		...
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_1.png" alt="icon" /></td>
		<td>Heikko mutta nopea auto tiedustelukäyttöön.</td>
	</tr>
	<tr>
		<td>Tankki (Tank)</td>
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_2.png" alt="icon" /></td>
		<td>Armeijasi perustyökalu.</td>
	</tr>
	<tr>
		<td>Raketinheitinauto (Missile Tank)</td>
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_4.png" alt="icon" /></td>
		<td>Hitaasti siirtyvä pitkän kantaman ase.</td>
	</tr>
	<tr>
		<td>Kaivoskuorma-auto (Mining truck)</td>
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_6.png" alt="icon" /></td>
		<td>Aseeton ajoneuvo malmin louhintaan.</td>
	</tr>
	<tr>
		<td>Supertankki (Super Tank)</td>
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_3.png" alt="icon" /></td>
		<td>Sitkeä ja tulivoimainen. Vaatii Tiedekeskus-rakennuksen</td>
	</tr>
	<tr>
		<td>Raskas heitin (Nuke cannon)</td>
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_5.png" alt="icon" /></td>
...
<table>
	<tr>
		...
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_54.png" alt="icon" /></td>
		<td>Useimmat rakennukset tarvitsevat sähköä toimiakseen, tämä voimala tuottaa sitä.</td>
	</tr>
	<tr>
		<td>Käsittelylaitos (Resource Yard)</td>
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_53.png" alt="icon" /></td>
	...
	<tr>
		...
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_52.png" alt="icon" /></td>
		<td>Valmistaa erilaisia yksiköitä.</td>
	</tr>
	<tr>
		<td>Tutka-asema (Radar building)</td>
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_56.png" alt="icon" /></td>
	...
	<tr>
		...
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_57.png" alt="icon" /></td>
	...
	<tr>
		...
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_59.png" alt="icon" /></td>
		<td>Pienitehoinen tykkitorni puolustuksen tueksi.</td>
	</tr>
	<tr>
		<td>Kaivos (Deep Bore Mine)</td>
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_55.png" alt="icon" /></td>
	...
	<tr>
		...
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_60.png" alt="icon" /></td>
		<td>Parempi tykkitorni puolustuksen tueksi. Vaatii Tiedekeskuksen</td>
	</tr>
	<tr>
		<td>Ohjussiilo (Nuke Silo)</td>
		<td><img class="icon" src="http://zemm.github.com/mazerts/icons/icon_58.png" alt="icon" /></td>
